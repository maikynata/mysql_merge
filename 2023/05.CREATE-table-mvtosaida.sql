...
SELECT nfeProc_NFe_infNFe_det_prod_cProd FROM mvtoSAIDA122023
...
SELECT * FROM bd_auditoria_2023.mvtosaida122023
WHERE nfeProc_NFe_infNFe_det_prod_cProd=407828;
