...
SELECT * FROM bd_auditoria_2024.nfe102024 WHERE nfeProc_NFe_infNFe_ide_dhEmi NOT LIKE '2024-10-%';
SELECT * FROM bd_auditoria_2024.nfe112024 WHERE nfeProc_NFe_infNFe_ide_dhEmi NOT LIKE '2024-11-%';
SELECT * FROM bd_auditoria_2024.nfe102024 WHERE nfeProc_NFe_infNFe_ide_dhEmi NOT LIKE '2024-12-%';


CREATE TABLE mvtoSAIDA102024 as (SELECT nfeProc_NFe_infNFe_det_prod_cProd, SUM(nfeProc_NFe_infNFe_det_prod_qCom) as qtd, nfeProc_NFe_infNFe_det_prod_CFOP 
FROM bd_auditoria_2024.nfe102024
...
SELECT * FROM mvtoSAIDA102024;

SELECT nfeProc_NFe_infNFe_det_prod_cProd FROM mvtoSAIDA102024
where nfeProc_NFe_infNFe_det_prod_cProd not in (SELECT COD_ITEM FROM bd_auditoria_2024.itenssaida);

-- SELECT * FROM bd_auditoria_2024.nfe102024 limit 10;

-- SELECT SUM(nfeProc_NFe_infNFe_det_prod_qCom) FROM bd_auditoria_2024.nfe102024
...
FROM bd_auditoria_2024.nfe102024
where nfeProc_NFe_infNFe_det_prod_cProd='407828' and nfeProc_NFe_infNFe_det_prod_CFOP in (5102,5152,5405,5409,5910,5911,5926,5949,6152,6409,6949,5202,5411,6202,6411,6108,5209,6209)
...
SELECT nfeProc_NFe_infNFe_det_prod_CFOP FROM bd_auditoria_2024.nfe102024
