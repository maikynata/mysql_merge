...
ADD COLUMN QTDnfe062024 DECIMAL(15.3),
ADD COLUMN QTDnfe062024 DECIMAL(15.3),
ADD COLUMN QTDnfe062024 DECIMAL(15.3),
ADD COLUMN QTDnfe062024 DECIMAL(15.3),
ADD COLUMN QTDnfe062024 DECIMAL(15.3),
ADD COLUMN QTDnfe062024 DECIMAL(15.3),
ADD COLUMN QTDnfe072024 DECIMAL(15.3),
ADD COLUMN QTDnfe082024 DECIMAL(15.3),
...
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
...
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida102024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);
CREATE INDEX idx_nfeProc_NFe_infNFe_det_prod_cProd ON bd_auditoria_2024.mvtosaida062024(nfeProc_NFe_infNFe_det_prod_cProd);


UPDATE bd_auditoria_2024.itenssaida INNER JOIN bd_auditoria_2024.mvtosaida062024
    ON bd_auditoria_2024.itenssaida.COD_ITEM = bd_auditoria_2024.mvtosaida062024.nfeProc_NFe_infNFe_det_prod_cProd
SET itenssaida.QTDnfe062024 = mvtosaida062024.qtd;
...
UPDATE bd_auditoria_2024.itenssaida
SET QTDnfe062024 = 0
where QTDnfe062024 is NULL;

-- Update total das saidas após corrigir o mes a mes:

UPDATE bd_auditoria_2024.itenssaida
SET TotalQTDnfe = (QTDnfe062024 + QTDnfe062024 + QTDnfe062024 + QTDnfe062024 + QTDnfe062024 + QTDnfe062024 + QTDnfe062024 + QTDnfe062024 + QTDnfe062024
+ QTDnfe102024 + QTDnfe112024 + QTDnfe062024);
