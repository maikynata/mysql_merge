...
SELECT nfeProc_NFe_infNFe_Id, nfeProc_NFe_infNFe_det_prod_cProd, nfeProc_NFe_infNFe_det_prod_cEAN FROM bd_auditoria_2023.nfe112023
where nfeProc_NFe_infNFe_det_prod_cProd='273660';

UPDATE nfe122023
SET nfe102023.nfeProc_NFe_infNFe_det_prod_cProd = 273660
WHERE nfe102023.nfeProc_NFe_infNFe_det_prod_cProd='7899884215906';
