...
CREATE TABLE mvtoSAIDA122024 as (SELECT nfeProc_NFe_infNFe_det_prod_cProd, SUM(nfeProc_NFe_infNFe_det_prod_qCom) as qtd, nfeProc_NFe_infNFe_det_prod_CFOP 
...
SELECT * FROM mvtoSAIDA122024;

SELECT nfeProc_NFe_infNFe_det_prod_cProd FROM mvtoSAIDA122024
where nfeProc_NFe_infNFe_det_prod_cProd not in (SELECT COD_ITEM FROM bd_auditoria_2024.itenssaida);

-- SELECT * FROM bd_auditoria_2024.nfe122024 limit 10;

-- SELECT SUM(nfeProc_NFe_infNFe_det_prod_qCom) FROM bd_auditoria_2024.nfe122024
...
SELECT nfeProc_NFe_infNFe_det_prod_CFOP FROM bd_auditoria_2024.nfe122024
