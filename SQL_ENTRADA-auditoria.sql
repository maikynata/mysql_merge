-- Entrada
CREATE TABLE mvtoEntrada as (SELECT COD_ITEM, SUM(QTD) as totalQTDEntrada, CFOP FROM bd_auditoria.reg_c170 where CFOP in (1102,1152,1403,1409,1910,1911,1926,1949,
